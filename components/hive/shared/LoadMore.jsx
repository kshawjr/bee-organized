...
export default function LoadMore({ pageSize, remaining, onClick }) {
  return (
    <button onClick={onClick}
      style={{ width: '100%', marginTop: '10px', padding: '9px', background: 'transparent', border: `0.5px dashed var(--hairline-border, ${HAIRLINE_BORDER})`, borderRadius: '10px', fontSize: '12px', color: `var(--text-muted, ${TEXT_MUTED})`, cursor: 'pointer', fontFamily: 'inherit' }}>
