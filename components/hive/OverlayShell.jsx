...
export default function OverlayShell({ isMobile, onClose, children }) {
    ...
    return (
      <div style={{ position: 'fixed', inset: 0, zIndex: 10005, display: 'flex', alignItems: 'flex-end', background: 'rgba(26,26,24,0.35)' }} onClick={onClose}>
        <div ref={scrollRef} onClick={e => e.stopPropagation()}
          style={{ background: '#fff', width: '100%', maxHeight: '88vh', overflowY: 'auto', overscrollBehavior: 'contain', WebkitOverflowScrolling: 'touch', borderRadius: '20px 20px 0 0', boxShadow: '0 -8px 40px rgba(26,26,24,0.2)' }}>
          <div
  ...
  return (
    <div style={{ position: 'fixed', inset: 0, zIndex: 10005, background: 'rgba(26,26,24,0.35)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '24px' }} onClick={onClose}>
      <div ref={scrollRef} onClick={e => e.stopPropagation()}
        style={{ width: '100%', maxWidth: '740px', maxHeight: '88vh', overflowY: 'auto', overscrollBehavior: 'contain', background: '#fff', borderRadius: '16px', boxShadow: '0 24px 80px rgba(26,26,24,0.25)' }}>
